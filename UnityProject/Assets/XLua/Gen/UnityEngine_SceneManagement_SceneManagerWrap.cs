...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSceneManagementSceneManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "MoveGameObjectsToScene", _m_MoveGameObjectsToScene_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "loadedSceneCount", _g_get_loadedSceneCount);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.SceneManagement.SceneManager();
        ...
        static int _m_GetActiveScene_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.GetActiveScene(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.SceneManagement.Scene _scene;translator.Get(L, 1, out _scene);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.SetActiveScene( _scene );
		    ...
		    try {
                ...
                
                {
                    string _scenePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.GetSceneByPath( _scenePath );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.GetSceneByName( _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _buildIndex = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.GetSceneByBuildIndex( _buildIndex );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.GetSceneAt( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _sceneName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.CreateScene( _sceneName );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.SceneManagement.CreateSceneParameters>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.CreateSceneParameters _parameters;translator.Get(L, 2, out _parameters);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.CreateScene( _sceneName, _parameters );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_MoveGameObjectsToScene_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.SceneManagement.SceneManager.MoveGameObjectsToScene( _entityIds, _scene );
		    ...
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneParameters>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.LoadSceneParameters _parameters;translator.Get(L, 2, out _parameters);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.LoadScene( _sceneBuildIndex, _parameters );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneParameters>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.LoadSceneParameters _parameters;translator.Get(L, 2, out _parameters);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.LoadScene( _sceneName, _parameters );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)) 
                {
                    int _sceneBuildIndex = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( _sceneBuildIndex );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _sceneName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( _sceneName );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneMode>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.LoadSceneMode _mode;translator.Get(L, 2, out _mode);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( _sceneBuildIndex, _mode );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneParameters>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.LoadSceneParameters _parameters;translator.Get(L, 2, out _parameters);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( _sceneBuildIndex, _parameters );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneMode>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.LoadSceneMode _mode;translator.Get(L, 2, out _mode);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( _sceneName, _mode );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.SceneManagement.LoadSceneParameters>(L, 2)) 
                {
                    ...
                    UnityEngine.SceneManagement.LoadSceneParameters _parameters;translator.Get(L, 2, out _parameters);
                        ...
                        var gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( _sceneName, _parameters );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_loadedSceneCount(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.xlua_pushinteger(L, UnityEngine.SceneManagement.SceneManager.loadedSceneCount);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
