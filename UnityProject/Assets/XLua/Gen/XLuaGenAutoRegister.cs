...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(CritFramework.LuaManager), CritFrameworkLuaManagerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(CritFramework.GameEntry), CritFrameworkGameEntryWrap.__Register);
