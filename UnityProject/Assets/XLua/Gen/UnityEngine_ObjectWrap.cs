...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetEntityId", _m_GetEntityId);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetEntityId(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetEntityId(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_InstantiateAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Object>(L, 1)&& translator.Assignable<UnityEngine.InstantiateParameters>(L, 2)&& translator.Assignable<System.Threading.CancellationToken>(L, 3)) 
                {
                    UnityEngine.Object _original = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 3, out _cancellationToken);
                        ...
                        var gen_ret = UnityEngine.Object.InstantiateAsync( _original, _parameters, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Object>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.InstantiateParameters>(L, 3)&& translator.Assignable<System.Threading.CancellationToken>(L, 4)) 
                {
                    UnityEngine.Object _original = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 4, out _cancellationToken);
                        ...
                        var gen_ret = UnityEngine.Object.InstantiateAsync( _original, _count, _parameters, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Object>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Quaternion>(L, 3)&& translator.Assignable<UnityEngine.InstantiateParameters>(L, 4)&& translator.Assignable<System.Threading.CancellationToken>(L, 5)) 
                {
                    UnityEngine.Object _original = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                    UnityEngine.Quaternion _rotation;translator.Get(L, 3, out _rotation);
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 5, out _cancellationToken);
                        ...
                        var gen_ret = UnityEngine.Object.InstantiateAsync( _original, _position, _rotation, _parameters, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 6&& translator.Assignable<UnityEngine.Object>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.Transform>(L, 3)&& translator.Assignable<UnityEngine.Vector3>(L, 4)&& translator.Assignable<UnityEngine.Quaternion>(L, 5)&& translator.Assignable<System.Threading.CancellationToken>(L, 6)) 
                {
                    UnityEngine.Object _original = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.Transform _parent = (UnityEngine.Transform)translator.GetObject(L, 3, typeof(UnityEngine.Transform));
                    UnityEngine.Vector3 _position;translator.Get(L, 4, out _position);
                    UnityEngine.Quaternion _rotation;translator.Get(L, 5, out _rotation);
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 6, out _cancellationToken);
                    
                        var gen_ret = UnityEngine.Object.InstantiateAsync( _original, _count, _parent, _position, _rotation, _cancellationToken );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 6&& translator.Assignable<UnityEngine.Object>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& translator.Assignable<UnityEngine.Quaternion>(L, 4)&& translator.Assignable<UnityEngine.InstantiateParameters>(L, 5)&& translator.Assignable<System.Threading.CancellationToken>(L, 6)) 
                {
                    UnityEngine.Object _original = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.Vector3 _position;translator.Get(L, 3, out _position);
                    ...
                    System.Threading.CancellationToken _cancellationToken;translator.Get(L, 6, out _cancellationToken);
                        ...
                        var gen_ret = UnityEngine.Object.InstantiateAsync( _original, _count, _position, _rotation, _parameters, _cancellationToken );
                        translator.Push(L, gen_ret);
